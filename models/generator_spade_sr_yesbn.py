...
def get_model(cfg):
    ...
    thermal_c1 = resblock_up(thermal_input, cfg['G_CONV_THERMAL_CH'], pre_activation=False, use_bn=True, neg_slope=cfg['RELU_NEG_SLOPE'], up_size=1)
    thermal_c2 = resblock_up(thermal_c1, cfg['G_CONV_THERMAL_CH'], neg_slope=cfg['RELU_NEG_SLOPE'], use_bn=True)
    thermal_c3 = resblock_up(thermal_c2, cfg['G_CONV_THERMAL_CH'], neg_slope=cfg['RELU_NEG_SLOPE'], use_bn=True)
    thermal_c4 = resblock_up(thermal_c3, cfg['G_CONV_THERMAL_CH'], neg_slope=cfg['RELU_NEG_SLOPE'], use_bn=True)
